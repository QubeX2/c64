...
start:
	...
	lda #$28                    // $2800 - screen data
	sta screenDataPtr + 1

	lda #$04                    // $0400 - screen memory
	sta screenMemPtr + 1

	lda #$e8                    // $2be8 - color data source
	sta colorDataPtr
	lda #$2b
	sta colorDataPtr + 1

	lda #$d8                    // $d800 - color memory
	sta colorMemPtr
...
// sprite #0
	...
	.byte $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $AA, $A2, $8A, $8A, $A2, $8A, $8A, $80, $82, $02, $80, $82, $02
	.byte 0
